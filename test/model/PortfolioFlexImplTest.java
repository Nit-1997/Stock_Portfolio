 ...
 public void testPortfolioFlexImplCreatorConst() throws Exception{
  ...
  public void testGetPerfDataOverTimePrintWeekly() throws Exception {
    ...
    String[] expectedLabels = {
            "OCT Week 1" , "OCT Week 2" , "OCT Week 3" , "OCT Week 4" , "NOV Week 1"
    };
    int index = 0;
    ...
    double[] expectedDatapoints = {
            373898.38 , 373469.56000000006 , 380245.86 , 383176.02 , 388085.44
    };
    index = 0;
  ...
  public void testGetPerfDataOverTimePrintMonthly() throws Exception {
    ...
    double[] expectedDatapoints = {
            411591.36,330741.95999999996,
            358955.86,323159.36,
            351070.42,350713.14,
            373679.4,409477.66000000003,
            377921.78,378650.94,
            404662.81999999995,
            372524.45999999996,373860.66000000003,
            388203.64
    };
    index = 0;
    for( double s  : ans.getValue()){
  ...
  public void testGetPerfDataOverTimePrintYearly() throws Exception {
    PortfolioFlex p = new PortfolioFlexImpl(this.generatePerfTestPortfolioOrder() , "perfTest");
    SimpleEntry<List<String>, List<Double>> ans = p.getPerfDataOverTime("2011-09-30","2019-11-01");
    String[] expectedLabels = {
            "2011","2012",
            "2013","2014",
            "2015","2016",
    ...
    System.out.println("");
    double[] expectedDatapoints = {
            22503.0,37934.829000000005,
            59965.060000000005,44564.58,
            93012.26,198278.14,
            285097.92000000004,
            326135.22000000003
    };
  ...
  public void testGetPerfDataOverTimePrintQtrly() throws Exception {
    ...
    double[] expectedDatapoints = {
            375211.78,378650.94,
            374682.10000000003,
            403549.86,198785.17999999996,
            255882.28000000003,272057.62,
            308883.74,339371.34,398463.44,
            421681.36000000004
    };
    index = 0;
    for( double s  : ans.getValue()){
