...
public class FlexControllerTest {
  ...
  public void testStart() {
    ...
    assertEquals(ViewConstants.FLEXIBLE_PORTFOLIO_HEADER + ViewConstants.MENU_MESSAGE
  ...
  public void testAddControllerOneStock() {
    ...
    assertEquals(ViewConstants.ADD_PORTFOLIO
            ...
            + ViewConstants.ADD_STOCKS_IN_PORTFOLIO_ASK_STOCK_NUMBER + ViewConstants.ASK_DATE
            + ViewConstants.ASK_COMMISSION_FEE + ViewConstants.ADD_STOCKS_IN_PORTFOLIO_CONFIRMATION
    ...
    assertEquals("unique name checker" + "\nget stock list" + "Name of ticker is AAPL" +
        "Name of"
        + " ticker is AAPL" + "checking the date 2022-01-01" + "\nInput controllerTest"
        + "\n stock map: \nAAPL->2022-01-01->" + "10.0,4.8\n", log.toString());
  }
  ...
  public void testAddControllerUnsuccessful() {
    ...
    assertEquals("unique name checker" + "\nget stock list" + "Name of ticker is META"
        + "Name of"
        + " ticker is META" + "checking the date 2010-01-05" + "\nInput controllerTest"
        + "\n stock map: \nMETA->2010-01-05->" + "10.0,4.8\n", log.toString());
  }
  ...
  public void testLoadSinglePortfolio() {
    ...
    LoadSingleFlexPortfolioDetail.loadSinglePortfolioDetailController(new Scanner(in), model, out,
        view);
    assertEquals(ViewConstants.ASK_NAME_OF_PORTFOLIO + "For the portfolio: "
        + "flexControllerTest\n"
  ...
  public void testLoadSinglePortfolioSummary() {
    ...
    assertEquals(ViewConstants.ASK_NAME_OF_PORTFOLIO + "For the portfolio: "
        + "flexControllerTest\n"
        + ViewConstants.LOAD_FLEX_PORTFOLIO_DETAIL_MENU + ViewConstants.WAIT_LOAD_MESSAGE
        + ViewConstants.ASK_DATE + "             Table for portfolio summary\n"
        + "----------------------------------------------------------\n"
    ...
    assertEquals("unique name checker" + "checking the date 2018-07-16"
        ...
        + "2018-07-16 is before date 2011-02-15", log.toString());
  }
  ...
  public void testLoadSinglePortfolioCurrentValue() {
    ...
    assertEquals(ViewConstants.ASK_NAME_OF_PORTFOLIO + "For the portfolio: "
        ...
        + ViewConstants.LOAD_FLEX_PORTFOLIO_DETAIL_MENU, bytes.toString());
    assertEquals("unique name checker" + "get portfolio creation date for "
        + "flexControllerTest" + date
        + " is before date 2011-02-15"
  ...
  public void testLoadSinglePortfolioHistoricValue() {
    ...
    assertEquals(ViewConstants.ASK_NAME_OF_PORTFOLIO + "For the portfolio:"
        + " flexControllerTest\n"
        + ViewConstants.LOAD_FLEX_PORTFOLIO_DETAIL_MENU + ViewConstants.ASK_DATE
        + ViewConstants.WAIT_LOAD_MESSAGE + "Value of the portfolio on that day: $0.00\n"
        + ViewConstants.LOAD_FLEX_PORTFOLIO_DETAIL_MENU, bytes.toString());
    assertEquals("unique name checker" + "checking the date 2018-09-28"
            + "get portfolio creation date for flexControllerTest"
            + "2018-09-28 is before date 2011-02-15"
            + "\ngetting portfolio value for flexControllerTest for the date 2018-09-28",
        log.toString());
  }
  ...
  public void testLoadSinglePortfolioBuyStock() {
    ...
    assertEquals(ViewConstants.ASK_NAME_OF_PORTFOLIO + "For the portfolio: "
        ...
        + "------------------------------------------------------------------------\n"
        + ViewConstants.ADD_STOCKS_IN_PORTFOLIO_ASK_TICKER_SYMBOL
        + ViewConstants.ADD_STOCKS_IN_PORTFOLIO_ASK_STOCK_NUMBER + ViewConstants.ASK_COMMISSION_FEE
        + ViewConstants.ASK_DATE + ViewConstants.SUCCESSFUL_TRANSACTION
        + ViewConstants.LOAD_FLEX_PORTFOLIO_DETAIL_MENU, bytes.toString());
  ...
  public void testLoadSinglePortfolioSellStock() {
    ...
    assertEquals("unique name checker" + "get portfolio state for flexControllerTest"
        + "Name of ticker is AAPL" + "Name of ticker is AAPL" + "checking the date 2018-09-28"
        + "2018-09-28 is before date 2016-03-29" + "transaction for portfolio flexControllerTest:\n"
        + "AAPL 2018-09-28 -6.0 4.8", log.toString());
  }
  ...
  public void testLoadSinglePortfolioCostBasis() {
    ...
    assertEquals("unique name checker" + "checking the date 2018-09-28"
        + "get portfolio creation date for flexControllerTest"
        + "2018-09-28 is before date 2011-02-15" + "checking the date 2018-09-28"
        + "get portfolio creation date for flexControllerTest"
        + "2018-09-28 is before date 2011-02-15"
  ...
  public void testLoadSinglePortfolioGraph() {
    ...
    assertEquals(ViewConstants.ASK_NAME_OF_PORTFOLIO + "For the portfolio:"
        + " flexControllerTest\n"
        + ViewConstants.LOAD_FLEX_PORTFOLIO_DETAIL_MENU + ViewConstants.WAIT_LOAD_MESSAGE
        + ViewConstants.ASK_START_DATE_FOR_GRAPH + ViewConstants.ASK_DATE
        + ViewConstants.ASK_END_DATE_FOR_GRAPH + ViewConstants.ASK_DATE
    ...
    assertEquals("unique name checker" + "get portfolio creation date for flexController"
            ...
            + "get graph data for flexControllerTest from 2022-01-01 to date 2022-06-06",
        log.toString());
  }
