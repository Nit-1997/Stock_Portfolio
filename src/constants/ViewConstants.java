...
public class ViewConstants {
  ...
  public static final String AskPortfolioNameAgain="Portfolio with this name already exists, kindly enter another name (0 to return to the main menu): ";
  ...
  public static final String StocksInPortfolioAddOrRemoveMenu="1. Add more stocks\n"+
      "2. Remove any stocks.\n"+
  ...
  public static final String AskConfirmation = "Do you want to add more stocks or remove any stocks (y/n)? ";

  public static final String WaitMessage = "\n Saving your portfolio, please wait...";
  public static final String AddStocksInPortfolioErrorNote="Please enter an integer value between 1 and 3: ";
  ...
  public static final String AskPortfolioNameAgainUnique = "No Portfolio with this name , kindly enter another name (0 to return to list view): ";
  ...
  public static final String AskDateAgain="Please enter date in the correct format (yyyy-MM-dd) in the given range (0 to return to list view): ";

  public static final String PrintInCompatiblePortfolio = "Manually entered portfolio is of incompatible type. \n";

  public static final String LoadPortfolioErrorNote="Please enter an integer value from above options: ";
