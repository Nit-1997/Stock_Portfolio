...
/**
 * Class for stock investment.
 */
public class InvestStock implements GUISubController {
  ...
  /**
   * Constructor for stock investment.
   *
   * @param investData investment data.
   * @param stockMap   map go stock vs weightage.
  ...
  public String execute() {
    ...
    try {
      ...
      if (amountDouble < 0) {
        return "Negative amount passed";
      }
      if (amountDouble == 0) {
        return "0 amount passed";
      }
