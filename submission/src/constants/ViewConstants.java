...
public class ViewConstants {
  ...
  public static final String ASK_TICKER_SYMBOL_AGAIN =
      "\nStock List doesn't contain this stock, enter" + " again:  (0 to return to main menu): ";
  ...
  public static final String ASK_CONFIRMATION =
      "Do you want to add more stocks or remove any " + "stocks (y/n)? ";

  public static final String WAIT_MESSAGE = "\n Saving your portfolio, please wait...";

  public static final String ADD_STOCKS_IN_PORTFOLIO_ERROR_NOTE =
  ...
  public static final String ASK_PORTFOLIO_NAME_AGAIN_UNIQUE =
      "No Portfolio with this name , kindly " + "enter another name (0 to return to list view): ";
  ...
  public static final String WRONG_DATE_MSG = "Please enter in the correct format in the given "
      + "range(0 to return to list view)\n";

  public static final String WRONG_DATE_BEFORE_LAST_TX = "kindly enter date after latest "
      + "transaction"
      + " for this stock(0 to return to list view)\n";

  public static final String WRONG_DATE_BEFORE_PORTFOLIO_CREATION = "kindly enter date after "
      + "portfolio creation(0 to return to list view)\n";

  public static final String SUCCESSFUL_TRANSACTION = "\ntransaction successful for the"
      + " portfolio\n\n";

  public static final String UNSUCCESSFUL_TRANSACTION = "\ntransaction unsuccessful\n\n";

  public static final String STOCK_NOT_IN_PORTFOLIO_MSG = "Portfolio doesn't contain this stock,"
      + " enter again(0 to return to main menu): ";

  public static final String STOCK_LESS_THAN_IN_PORTFOLIO = "Shares to be sold are more than the "
      + "number of shares existing\n";
